...
namespace Templet
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //If your program works in different version of F1game like "F1 2020/F1 2021/F1 22",you need to parse the packet like below,
            ...
            //or you don't care about the shit of GameSeries,just want some basic data fields,parse the packet to someone in namespace "F1_Telemetry_Adapter.F1_Base_packets"
            switch (pack.PacketHeader._PacketType)
            {
                case PacketType.CarTelemetry:
                    var newPack = pack as CarTelemetryPacket;

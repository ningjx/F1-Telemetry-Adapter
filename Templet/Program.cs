...
namespace Templet
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //or you don't care about the shit of GameSeries,just want some basic data fields,parse the packet to someone in namespace "F1_Telemetry_Adapter.F1_Base_packets" directly.

...
namespace NingSoft.F1TelemetryAdapter.F1_20_packets
{
    ...
    /// Version: 1
    /// </summary>
    public class ParticipantsPacket20 : F1Packet
    {
        public override int Length => 1213;
        ...
        public ParticipantData20[] Participants;

        public ParticipantsPacket20(HeaderPacket header, Bytes bys) : base(header, bys) { }
    ...
    public class ParticipantData20
    {
        /// <summary>

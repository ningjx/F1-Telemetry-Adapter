...
namespace NingSoft.F1TelemetryAdapter.F1_20_packets
{
    ...
    /// Version: 1
    /// </summary>
    public class LobbyInfoPacket20 : F1Packet
    {
        public override int Length => 1169;
        ...
        /// </summary>
        public LobbyInfoData20[] LobbyInfoData;

        public LobbyInfoPacket20(HeaderPacket header, Bytes bys) : base(header, bys) { }
